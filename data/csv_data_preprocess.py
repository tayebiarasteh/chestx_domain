...
class normalizer_resizer():
    def __init__(self, cfg_path="chestx_domain/config/config.yaml"):
        pass
    ...
    def padchest_normalizer_resizer(self):
        ...
        for image_path in tqdm(file_list):
            ...
            try:
                ...
                print(image_path)
                with open("/padchest" + '/error_files', 'a') as f:
                    f.write(image_path)
                continue
...
class csv_preprocess_chexpert():
    ...
    def class_num_change(self):
        ...
        input_path = "/valid.csv"
        newoutput_path = "/valid_master_list.csv"
...
if __name__ == '__main__':
    ...
    handler.vindr_normalizer_resizer()
